...
**Nothing runs yet.** This repository holds the license, the contribution rules and CI.
There is no install, no API and no release. This README will document the whole public
surface as it lands.
